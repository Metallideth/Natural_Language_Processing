...
class DistilBERTClass(torch.nn.Module):
    def __init__(self):
        ...
        for i in range(3): # Only keep first 3 transformer blocks
            new_module_list.append(dbert.transformer.layer[i]) 
        self.l1 = copy.deepcopy(dbert)
        self.l1.transformer.layer = new_module_list
